...
window.onload = () => {
    ...
    function datumFun() {
        ...
        var bulmaLogo = `<img src="https://bulma.io/images/made-with-bulma--semiwhite.png" alt="Made with Bulma" width="128" height="24">`;
        var keycapLogo = `<link rel="shortcut icon" href="img/pbt-white.png" type="image/x-icon" />`;
        if (satnica > 22 || satnica < 6) {
    ...
    // if (window.location.pathname == '/products.php' || window.location.pathname == '/Products.html') {
    // } //if products.php

...
try {
    ...
    document.querySelector("#brandSelect").addEventListener('change', () => {
        ...
        if (selectedBrandID > 0) {
            ...
            $.ajax('adminModules/adminCarAdd_GetModel.php', {
                method: 'post',
                data: {
            ...
            $.ajax('adminModules/adminCarAdd_GetInfo.php', {
                method: "get",
                success: (features) => {
                ...
                <button class = "modal-close is-large button is-dark" aria-label = "close"></button>
                    ...
                    $(".modal-button-image").click(function () {
                        ...
                        if (formErr.length < 1) {
                            ...
                            $.ajax('adminModules/adminCarAdd_New.php', {
                                method: 'post',
                                // contentType: false,
                                // processData: false,
                                data: {
                                ...
                                success: addCarServerResponse => {
                                    ...
                                    $('.submitFile').on('click', function () {
                                        ...
                                        if (file_data != undefined) {
                                            var form_data = new FormData();
                                            form_data.append('file', file_data);
                                            $.ajax('adminModules/adminCarAdd_File.php', {
                                                type: 'POST',
                                                contentType: false,
                                                processData: false,
                                                data: form_data,

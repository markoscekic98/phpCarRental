                ...
                <div class="tile is-ancestor is-centered">
                    <div class="tile is-6 is-vertical is-parent m-3  notification darker adminTiles">
                        <div class="tile is-child ">
                            ...
                            <div class="buttons ">
                                <button class="button is-medium is-info is-outlined is-light " id="peropero">Show all users</button>
                                <button class="button is-medium is-info is-outlined is-light " id="">Add new user</button>
                                <button class="button is-medium is-warning is-outlined is-light " id="">Update user info</button>
